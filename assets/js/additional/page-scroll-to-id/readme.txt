...
The plugin replaces the default browser behaviour of "jumping" to page sections when links with href value containing # are clicked, by smoothly animating the page to those sections. Features include: 
...
Github: https://github.com/malihu/page-scroll-to-id
