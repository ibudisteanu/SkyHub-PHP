function validateLoginForm(object, iLoginNo) {
    var sId = object.id;
...
function validateLoginFormPost(object, iLoginNo)
{
    var bCheck =true;
    bCheck  = validateLoginForm($("#login-username"+iLoginNo)[0],iLoginNo) && bCheck ;
    bCheck  = validateLoginForm($("#login-password"+iLoginNo)[0],iLoginNo) && bCheck ;
