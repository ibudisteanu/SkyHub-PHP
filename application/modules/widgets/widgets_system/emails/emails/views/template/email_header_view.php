                                                                ...
                                                                <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width:100%;">
                                                                    <tr>
                                                                        <td align="left" class="textContent">
                                                                            <!-- CONTENT // -->
                                                                            <div style="font-family:Helvetica,Arial,sans-serif;font-size:13px;color:#828282;text-align:center;line-height:120%;">
                                                                                If you can't see this message, <a href="<?=$dtEmail->getEmailURL()?>" target="_blank" style="text-decoration:none;border-bottom:1px solid #828282;color:#828282;"><span style="color:#828282;">view it in your browser</span></a>.
                                                                            </div>
                                                                        </td>
                                                                    </tr>
                                                                </table>
                                ...
                                <tr>
                                    <td align="center" valign="top">
                                        ...
                                        <table border="0" cellpadding="0" cellspacing="0" width="600" class="flexibleContainer">
                                            <tr>
                                                <td align="center" valign="top" width="600" class="flexibleContainerCell" style="padding: 10px">
                                                    ...
                                                    <table border="0" cellpadding="10" cellspacing="0" width="100%">
                                                        <tr>
                                                            <td align="center" valign="top" class="textContent">
                                                                <h1 style="color:#FFFFFF;line-height:100%;font-family:Helvetica,Arial,sans-serif;font-size:<?=strlen($dtEmail->sSubject) < 15 ? '35' : '17' ?>px;font-weight:normal;margin-bottom:5px;text-align:center;"><?=$dtEmail->sSubject?></h1>
                                                                <?php ?>
                                                                <div style="margin: -10px; padding-top:10px; padding-bottom: 15px">
                                                                    <a href="<?=base_url('')?>"><img src="<?=base_url('theme/images/SkyHub-logo.png')?>" alt="<?=WEBSITE_TITLE?>" ></a>
                                                                </div>
                                                                <div style="padding-left:20px; padding-right:20px; text-align:center;font-family:Helvetica,Arial,sans-serif;font-size:15px;margin-bottom:0;color:#FFFFFF;line-height:135%;"><?=$dtEmail->sMessage?></div>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                    <!-- // CONTENT TABLE -->
                                        ...
                                        <table border="0" cellpadding="0" cellspacing="0" width="600" class="flexibleContainer">
                                            <tr>
                                                <td align="center" valign="top" width="600" class="flexibleContainerCell">
                                                    <table border="0" cellpadding="0" style="margin-top:10px; margin-bottom: 10px; width: 90%" cellspacing="0" width="100%">
                                                        <tr>
                                                            <td align="center" valign="top">
