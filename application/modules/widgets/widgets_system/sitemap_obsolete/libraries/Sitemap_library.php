...
// Skip URLs from the $skip_url array
    ...
    public  function start()
    {
        ...
        if (!$this->pf)
        {
            echo "Cannot create " . $this->OUTPUT_FILE . "!" . NL;
            return;
        }
        ...
        echo "Done." . NL;
        echo $this->OUTPUT_FILE . " created." . NL;
    }
