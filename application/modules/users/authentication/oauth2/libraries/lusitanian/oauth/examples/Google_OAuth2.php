...
$objGoogleOAuth2 = new Google_OAuth2();
...
if (!empty($_GET['code'])) {
    ...
    $objGoogleOAuth2->arrResult = json_decode($googleService->request('userinfo'), true);

    // Show some of the resultant data
    //echo 'Your unique google user id is: ' . $this->arrResult['id'] . ' and your name is ' . $this->arrResult['name'];
    //var_dump($this->arrResult);

    $objGoogleOAuth2->bSuccess=true;
