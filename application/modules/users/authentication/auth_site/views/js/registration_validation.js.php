function validateRegistrationForm<?=$iRegistrationNo?>(object, bTimeOut, bHideToolTip) {
...
function validateRegistrationFormPost<?=$iRegistrationNo?>()
{
    var bCheck=true;
    bCheck = validateRegistrationForm<?=$iRegistrationNo?>($("#register-username<?=$iRegistrationNo?>")[0],true, !bCheck) && bCheck;
    console.log(bCheck);
    bCheck = validateRegistrationForm<?=$iRegistrationNo?>($("#register-email<?=$iRegistrationNo?>")[0],true, !bCheck) && bCheck;
    console.log(bCheck);
    bCheck = validateRegistrationForm<?=$iRegistrationNo?>($("#register-firstName<?=$iRegistrationNo?>")[0],true, !bCheck) && bCheck;
    console.log(bCheck);
    bCheck = validateRegistrationForm<?=$iRegistrationNo?>($("#register-lastName<?=$iRegistrationNo?>")[0],true, !bCheck) && bCheck;
    console.log(bCheck);
    bCheck = validateRegistrationForm<?=$iRegistrationNo?>($("#register-password<?=$iRegistrationNo?>")[0],true, !bCheck) && bCheck;
    console.log(bCheck);
    bCheck = validateRegistrationForm<?=$iRegistrationNo?>($("#register-passwordConfirmation<?=$iRegistrationNo?>")[0],true, !bCheck) && bCheck;
    console.log(bCheck);
    bCheck = validateRegistrationForm<?=$iRegistrationNo?>($("#register-city<?=$iRegistrationNo?>")[0],true, !bCheck) && bCheck;
    console.log(bCheck);
    bCheck = validateRegistrationForm<?=$iRegistrationNo?>($("#register-countrySelectorCode<?=$iRegistrationNo?>")[0],true, !bCheck) && bCheck;
