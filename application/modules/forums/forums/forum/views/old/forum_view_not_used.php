<div class="row" style="margin-left: 35px; margin-right: 5px">
    ...
    <table class="table forum table-striped">
        ...
        <tr>
            ...
            <td>
                <h4 style="margin-top:0px"><a href="#">Frequently Asked Questions</a><br><small>Some description</small></h4>
            </td>
        ...
        <tr>
            ...
            <td>
                <h4 style="margin-top:0px"><a href="#">Important changes</a><br><small>Category description</small></h4>
            </td>
